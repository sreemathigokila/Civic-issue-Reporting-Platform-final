    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                .requestMatchers("/api/auth/**", "/h2-console/**", "/ws/**", "/uploads/**", "/api/departments/**", "/api/districts/**", "/api/complaints/code/**").permitAll()
                .requestMatchers("/api/complaints/**", "/api/notifications/**").permitAll()
                .requestMatchers("/api/admin/**").permitAll()
                .requestMatchers("/api/depthead/**").permitAll()
