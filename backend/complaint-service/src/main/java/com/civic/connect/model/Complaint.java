...
public class Complaint extends BaseEntity {
    ...
    @Column(name = "work_deadline", length = 100)
    ...
    public static class Builder {
        ...
        public Builder workDeadline(String val) { c.workDeadline = val; return this; }
    ...
    public String getWorkDeadline() { return workDeadline; }
    public void setWorkDeadline(String workDeadline) { this.workDeadline = workDeadline; }
}
